...
# --- Tasks ---
morning_walk = Task(title="Morning walk", duration_minutes=30, priority="high", required_species="dog")
...
playtime = Task(title="Playtime", duration_minutes=25, priority="medium")
...
# --- Pets ---
mochi = Pet(name="Mochi", species="dog", age=3, tasks=[morning_walk, feeding, grooming, playtime])
